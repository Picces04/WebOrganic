$(function () {
	...
	const formContainer = document.getElementById("insertProductFormContainer");

	if (addNewButton && formContainer) {
		addNewButton.addEventListener("click", function () {
			const isFormVisible = formContainer.style.display === "block";
			formContainer.style.display = isFormVisible ? "none" : "block";
			this.textContent = isFormVisible ? "Thêm mới" : "Đóng lại";
		});
	}
});
...
// 		this.textContent = "Đóng lại"; // Thay đổi text của nút
// 	} else {
// 		formContainer.style.display = "none"; // Ẩn form
// 		this.textContent = "Thêm mới"; // Khôi phục text của nút
// 	}
// });