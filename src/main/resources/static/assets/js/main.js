...
---------------------------- */	
    $(".categories_title").on("click", function() {
        ...
        var menu = $('.categories_menu_toggle');

        // Tự động toggle Bootstrap collapse
...
-------------------------------*/
    ...
    let minPrice = parseFloat($("#min-price").val()) || 0; // Giá trị mặc định là 0 nếu không có giá trị
    let maxPrice = parseFloat($("#max-price").val()) || 150000; // Giá trị mặc định là 200000 nếu không có giá trị
$( "#price-slider" ).slider({
   range: true,
   min: 0,
   max: 250000,
...
------------------------------*/
    $('.category-sub-menu li.has-sub > a').hover(
        ...
        function () {
            ...
            // Hủy timeout nếu chưa hết thời gian
